		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD xP4NiC BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] xP4NiC? Este é um recurso especial para o xP4NiC ❌',
					ownerB: '[❗] xP4NiC? Este é um recurso especial para o xP4NiC ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de xP4NiC. Registre-se para fazer amizade com o bot xP4NiC por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar xP4NiC|17\n\n──「 xP4NiC BOT 」──`,
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("trolei")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/gemidao.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("siri")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/siribarra.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/tiringa.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	        if (messagesC.includes("marreta")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/zoiomarreta.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	        ...
	        if (messagesC.includes("tira")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/tiranao.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/maconheiro.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
case 'boanoite':
tujuh = fs.readFileSync('./assets/consagrado.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'cca':
...
break
case 'ccf':
tujuh = fs.readFileSync('./assets/ccf.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ccg':
...
break
case 'cachorrinho':
tujuh = fs.readFileSync('./assets/cachorrinho.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'esskeetit':
...
break
case 'downbelow':
tujuh = fs.readFileSync('./assets/downbelow.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rapsolitario':
...
break
case 'artigo157':
tujuh = fs.readFileSync('./assets/artigo157.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'olhaapedra':
tujuh = fs.readFileSync('./assets/olhaapedra.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS xP4NiC BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @xP4NiC domina vida
          ...
          reply('Espere..')
			    ...
			    case 'owner':
                    ...
                    client.sendMessage(from, '*CONTATO DO MEU DONO AI*',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o xP4NiC ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT xP4NiC ✨* 」\n*│+ wa.me/5554996535602*╰──────*「 *xP4NiC* 」*────*\n\n*_SE QUER SER ADMIN DO BOT xP4NiC_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/555496535602/*╰──────*「 * xP4NiC* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO xP4NiC BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do xP4NiC:*\n\n https://youtube.com/channel/UCkpUBsMtlYpZEpJwT1-PTrw'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
